...
class Token(object):
    ...
    def __init__(self, client, token):
        ...
        self.web3 = client.web3
        self.api_key = client.api_key
        self.blockchain = client.blockchain
        self.private_key = client.private_key
        try:
            self.token_address = self.web3.toChecksumAddress(token)
            self.token_name = "Uknown"
        except ValueError as e:
            self.token_address = self.web3.toChecksumAddress(self.known_tokens[token])
